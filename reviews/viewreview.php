    ...
    <body>
        <main class="main-view-review">
            <section class='view-review'>
                ...
                <p class="line"><span class="label">Your satisfaction level</span>
                <span class="answer"> <?= $row['satisfaction'] ?? 'Not specified' ?></span>
                </p>
                <p class="line"><span class="label">Did you find your lost item?</span>
                <span class="answer"> <?= isset($row['found']) ? ($row['found'] == 1 ? 'Yes' : 'No') : 'Not specified' ?></span>
                </p>
                <p class="line"><span class="label">Do you want to recommend us to your friends and family?</span>
                <span class="answer"> <?= isset($row['recommend']) ? ($row['recommend'] == 1 ? 'Yes' : 'No') : 'Not specified' ?></span>
                </p>
                <p class="line"><span class="label">Your review:</span>
